...
const UserInput = (props: UserInputProps) => {
    ...
    const addEmoji = (e:EmojiClickData) => {
        if (!activeChat || !activeServer) return
    ...
    return (
        <>
            <form ref={formRef} onSubmit={submitHandler}>   
                <fieldset className="flex mx-4 mb-6 mt-2 bg-chat-input-bg relative" disabled={
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="h-11 py-2.5 px-4 group cursor-pointer" onClick={() => {setShowEmojiPicker(prev => !prev)}}>
                    ...
                    {
                        <div className={`emoji-picker ${showEmojiPicker && 'scale-100'}`}>
                            <EmojiPicker

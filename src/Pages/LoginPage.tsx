...
import myLinkedInUrl from "../assets/images/loginPage/qr-code.png";
                        ...
                        <div className="flex-grow">
                            ...
                            <div className="w-full mt-5">
                                ...
                                <div className="grid grid-cols-3 gap-5">
                                    ...
                                    <button type="submit" className="col-span-2 order-2 other-button text-white text-base mb-2 px-4 py-[10px] bg-[var(--rang-brand)] hover:bg-[#4752c4] transition-all duration-200 rounded-md font-semibold">Log In</button>
                                </div>
                                <p className="text-sm text-[color:#a3a6aa] pl-[2px] mt-2">Need an account? <a onClick={(e) => goToRegisterPage(e)} className="font-medium text-[var(--rang-text-link)] text-sm" href="/register">Register</a></p>
                            </div>
                        </div>
